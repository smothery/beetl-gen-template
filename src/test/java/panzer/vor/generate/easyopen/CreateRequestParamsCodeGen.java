 ...
 * @create 2018-10-11
 */
public class CreateRequestParamsCodeGen implements CodeGen {
    private String template;
    private SQLManager sm;

    public CreateRequestParamsCodeGen(SQLManager sm) {
        this.sm = sm;
        this.template = (new GenConfig()).getTemplate("/easyopen/ext_create_params.btl");
    }
    ...
    public void genCode(String entityPkg, String entityClass, TableDesc tableDesc, GenConfig config, boolean isDisplay) {
        ...
        String className = entityClass + "CreateRequestParams";
        ...
        if (isDisplay) {
            ...
            try {
                ...
                throw new RuntimeException("CreateRequestParams代码生成失败", var11);
            }
        }
    }
