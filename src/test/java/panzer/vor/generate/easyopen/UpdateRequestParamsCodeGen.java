 ...
 * @create 2018-10-11
 */
public class UpdateRequestParamsCodeGen implements CodeGen {
    private String template;
    private SQLManager sm;

    public UpdateRequestParamsCodeGen(SQLManager sm) {
        this.sm = sm;
        this.template = (new GenConfig()).getTemplate("/easyopen/ext_update_params.btl");
    }
    ...
    public void genCode(String entityPkg, String entityClass, TableDesc tableDesc, GenConfig config, boolean isDisplay) {
        ...
        String className = entityClass + "UpdateRequestParams";
        ...
        if (isDisplay) {
            ...
            try {
                ...
                throw new RuntimeException("UpdateRequestParams代码生成失败", var11);
            }
        }
    }
