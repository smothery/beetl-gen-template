 ...
 * @create 2018-10-11
 */
public class DTOCodeGen implements CodeGen {
    private String template;
    private SQLManager sm;

    public DTOCodeGen(SQLManager sm) {
        this.sm = sm;
        this.template = (new GenConfig()).getTemplate("/easyopen/ext_dto.btl");
    }
    ...
    public void genCode(String entityPkg, String entityClass, TableDesc tableDesc, GenConfig config, boolean isDisplay) {
        ...
        String className = entityClass + "DTO";
        ...
        if (isDisplay) {
            ...
            try {
                ...
                throw new RuntimeException("dto代码生成失败", var11);
            }
        }
    }
